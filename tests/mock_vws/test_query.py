...
_JETTY_ERROR_DELETION_NOT_COMPLETE = textwrap.dedent(
    ...
    <head>
    <meta http-equiv="Content-Type" content="text/html;charset=utf-8"/>
    <title>Error 500 org.jboss.resteasy.spi.UnhandledException: com.fasterxml.jackson.databind.exc.MismatchedInputException: No content to map due to end-of-input
     at [Source: (byte[])&quot;&quot;; line: 1, column: 0]</title>
    </head>
    <body><h2>HTTP ERROR 500 org.jboss.resteasy.spi.UnhandledException: com.fasterxml.jackson.databind.exc.MismatchedInputException: No content to map due to end-of-input
     at [Source: (byte[])&quot;&quot;; line: 1, column: 0]</h2>
    <table>
    <tr><th>URI:</th><td>/v1/query</td></tr>
    <tr><th>STATUS:</th><td>500</td></tr>
    <tr><th>MESSAGE:</th><td>org.jboss.resteasy.spi.UnhandledException: com.fasterxml.jackson.databind.exc.MismatchedInputException: No content to map due to end-of-input
     at [Source: (byte[])&quot;&quot;; line: 1, column: 0]</td></tr>
    <tr><th>SERVLET:</th><td>Resteasy</td></tr>
    <tr><th>CAUSED BY:</th><td>org.jboss.resteasy.spi.UnhandledException: com.fasterxml.jackson.databind.exc.MismatchedInputException: No content to map due to end-of-input
     at [Source: (byte[])&quot;&quot;; line: 1, column: 0]</td></tr>
    <tr><th>CAUSED BY:</th><td>com.fasterxml.jackson.databind.exc.MismatchedInputException: No content to map due to end-of-input
     at [Source: (byte[])&quot;&quot;; line: 1, column: 0]</td></tr>
    </table>
    <h3>Caused by:</h3><pre>org.jboss.resteasy.spi.UnhandledException: com.fasterxml.jackson.databind.exc.MismatchedInputException: No content to map due to end-of-input
