...
ValueError being raised during parsing. The default value of this variable is
0, meaning the request size is unlimited.
"""
...
def parse_multipart(
    ...
    Args:
        ...
        errors: request error handler, passed to FieldStorage
...
class FieldStorage:
    ...
    def read_lines(self):
        ...
        if self._binary_file:
            self.file = (
                self.__file
            ) = BytesIO()  # store data as bytes for files
        else:
